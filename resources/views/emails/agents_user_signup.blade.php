...
<style type="text/css">
  ...
  .content td..content-td pre code {
...
.intercom-interblocks-article-icon {
  ...
  background-image: url('https://pixilink.intercom-mail.com/assets/article_book-1a595be287f73c0d02f548f513bfc831.png') !important;
...
<tr>
            <td class="content-td" style="color: #818181; font-family: Helvetica, Arial, sans-serif; font-size: 16px; line-height: 150%; padding: 0 0 60px">
              @if($phoneVerified)
              <h1 class="intercom-align-center" style="color: #2392ec !important; font-size: 36px; font-weight: 300; line-height: 1.2; margin: 0 0 5px; padding-left: 10%; padding-right: 10%; text-align: center !important" align="center">Phone number Verified!</h1><br/>
              @else
              <h1 class="intercom-align-center" style="color: #2392ec !important; font-size: 36px; font-weight: 300; line-height: 1.2; margin: 0 0 5px; padding-left: 10%; padding-right: 10%; text-align: center !important" align="center">You got a New User</h1><br/>
              @endif
<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%; text-align: left !important" align="left"></p>
@php $agent = $user->loginWithAgent()->first();
$hashids = new Hashids\Hashids(config('constants.email_token_salt'), config('constants.token_length'), config('constants.token_char'));
$token = $hashids->encode($agent->agent_id);
@endphp
@if($phoneVerified)
<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%; " align="left">Hi {{$agent->fname}},</p>
<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%; " align="left">The below user has now verified their phone number. Users are requried to verify their phone number after 10 property views. <br/>&nbsp;</p>
<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%; " align="left">Your user details:</p>
@else
<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%; " align="left">Congratulations {{$agent->fname}},</p>
<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%; " align="left">You have a new user. Reach out and introduce yourself to them.<br/>&nbsp;</p>
<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%; " align="left">Your new user details:</p>
@endif
<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%;" ><strong>Name:</strong>{{$user->first}} {{$user->last}}</p>
{{--  @if($phoneVerified)  --}}
<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%;" ><strong>Phone:</strong>{{$user->phone}}</p>
{{--  @endif  --}}
<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%;" ><strong>Email:</strong>{{$user->email}}<br/>&nbsp;</p>

<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%;" >Looking for a list of all your users?  Click on: <a href="{{$user->agentAdminLink()}}" rel="notrack" target="_blank">{{$user->agentAdminLink()}}</a></p>
<p class="intercom-align-left" style="font-size: 16px; margin: 0; padding-left: 10%; padding-right: 10%; text-align: left !important" align="left"><br>Thanks,<br>Team Pixilink & Fisherly</p>
  ...
  <!-- Footer -->
    ...
    <table cellspacing="0" border="0" cellpadding="0" align="center" width="100%" bgcolor="transparent" class="main footer" style="background-color: #f8f8f8; border-collapse: separate; border-spacing: 0; font-family: Helvetica, Arial, sans-serif; letter-spacing: 0; max-width: 800px; table-layout: fixed">
      <tbody>
<tr>
  ...
  {{--  <p class="social" style="color: #a8a8a8; font-size: 13px; font-weight: 300; line-height: 1.5; margin: 27px 0 20px; text-decoration: none">
      ...
      <a href="https://www.facebook.com/PixilinkSolutions/" style="border: none; color: #a8a8a8; font-size: 13px; outline: none !important; text-decoration: none"><img alt="Facebook" src="https://pixilink.intercom-mail.com/assets/email/broadcast/facebook-2263526f2b7c7cf3c7c2a066588b01ef.png" width="60"></a>
    
    
      <a href="https://www.twitter.com/pixilink" style="border: none; color: #a8a8a8; font-size: 13px; outline: none !important; text-decoration: none"><img alt="Twitter" src="https://pixilink.intercom-mail.com/assets/email/broadcast/twitter-fe222f8697fa267d095338db3f583c94.png" width="60"></a>
  ...
  <p style="color: #a8a8a8; font-size: 13px; font-weight: 300; line-height: 1.5; margin: 0 0 10px; text-decoration: none">201-350 E 2nd Ave, Vancouver, BC, V5T 4R8</p>
              ...
              <p class="unsub" style="color: #a8a8a8; font-size: 13px; font-weight: 300; line-height: 1.5; margin: 0; text-decoration: none"><a href="https://www.fisherly.com/unsubscribe_emails?type=agent&service=newuser_notifications&token={{$token}}" target="_blank" style="border: none; color: #a8a8a8; font-size: 13px; outline: none !important; text-decoration: underline">Unsubscribe from this notification</a></p>
...
<img src="https://pixilink.intercom-mail.com/via/o?h=c7dc0bfd5c9c489cf4ef372e153ce3b8576b5468-" width="1" height="1" style="display: block;" alt="intercom">

<img border="0" width="1" height="1" alt="" src="https://pixilink.intercom-mail.com/q/a8APht79InnXICEiNPHXeg~~/AAAAAQA~/RgRee5zWPlcIaW50ZXJjb21CCgAe1heZXFw9cuhSFnBhcnZpbmRlckBwaXhpbGluay5jb21YBAAACs0~">
</body>
</html>