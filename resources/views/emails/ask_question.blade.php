                           ...
                           <tbody>
                                 <tr>
                                             <td class="m_-1624966506584891120m_1797051753981600141content-td" style="color:#818181;font-family:Helvetica,Arial,sans-serif;font-size:16px;line-height:150%;padding:0 0 60px">
                                                 ...
                                                 <h1 class="m_-1624966506584891120m_1797051753981600141intercom-align-center" style="color:#2392ec!important;font-size:36px;font-weight:300;line-height:1.2;margin:0 0 5px;padding-left:10%;padding-right:10%;text-align:center!important" align="center">Question<br>
                                 </h1>
                                 ...
                                 <p class="m_-1624966506584891120m_1797051753981600141intercom-align-left" style="font-size:16px;margin:0 0 13px;padding-left:10%;padding-right:10%;text-align:left!important" align="left"><b style="color:#606060">Name: </b>{{$user->first}} {{$user->last}}<br><b style="color:#606060">Email: </b><a href="mailto:{{$user->email}}" style="border:none;color:#178acc;outline:none!important;text-decoration:underline" target="_blank">{{$user->email}}</a><br><b style="color:#606060">Phone: </b>{{$user->phone}}<br><b style="color:#606060">IP:</b>	{{$data['ip_address']}}<br><b style="color:#606060">Country:</b>{{$data['country']}}</p>
                              </span><h2 class="m_-2651509807509513694intercom-align-left" style="color:#303030;font-size:21px;font-weight:bold;line-height:1.25;margin:30px 0 5px;padding-left:10%;padding-right:10%;text-align:left!important" align="left">Question:</h2>
                              <p class="m_-2651509807509513694intercom-align-left" style="font-size:16px;margin:0 0 13px;padding-left:10%;padding-right:10%;text-align:left!important" align="left">{{$data['message']}}</p>
                              ...
                              <p class="m_-1624966506584891120m_1797051753981600141intercom-align-left" style="font-size:16px;margin:0 0 13px;padding-left:10%;padding-right:10%;text-align:left!important" align="left"><b style="color:#606060">Signed up: </b>{{$data['user_signup_date']}}<br><b style="color:#606060">Total Properties Viewed: </b>{{$user->total_properties_viewed()}}</p>
                                 <h2 class="m_-1624966506584891120m_1797051753981600141intercom-align-left" style="color:#303030;font-size:21px;font-weight:bold;line-height:1.25;margin:30px 0 5px;padding-left:10%;padding-right:10%;text-align:left!important" align="left">@if($data['type']=='building') Building @else Property: @endif</h2>
                                 @if($data['type']=='building')
                                    <p class="m_-1624966506584891120m_1797051753981600141intercom-align-left" style="font-size:16px;margin:0 0 13px;padding-left:10%;padding-right:10%;text-align:left!important" align="left"><b style="color:#606060">Building:</b> <a href="{{route('building-detail-page', [$agent->vow_username, $listing->slug])}}" rel="notrack" >{{$listing->name}}</a><br><b style="color:#606060">Address:</b>	<a href="{{route('building-detail-page', [$agent->vow_username, $listing->slug])}}" rel="notrack" >{{$listing->address()}}</a></p>
                                 @else
                                    <p class="m_-1624966506584891120m_1797051753981600141intercom-align-left" style="font-size:16px;margin:0 0 13px;padding-left:10%;padding-right:10%;text-align:left!important" align="left"><b style="color:#606060">MLS®:</b> <a href="{{route('listing-detail-page2', [$agent->vow_username, $listing->slug])}}">{{$listing->listingid}}</a><br><b style="color:#606060">Address:</b>	<a href="{{route('listing-detail-page2', [$agent->vow_username, $listing->slug])}}">{{$listing->streetaddress}}, {{$listing->city}}</a><br><b style="color:#606060">Days On Market:</b> @if($listing->status == 'Active') {{$listing->active_days_on_market()}} @else {{$listing->days_on_market()}} @endif<br><b style="color:#606060">Listing Status:</b>{{$listing->status}} </p> 
                                 @endif
                                 @if($data['type']!='building')
                                 ...
                                 <p class="m_-1624966506584891120m_1797051753981600141intercom-align-left" style="font-size:16px;margin:0;padding-left:10%;padding-right:10%;text-align:left!important" align="left"><b style="color:#606060">Name:</b> {{$listing->agent_name}}<br><b style="color:#606060">Brokerage: </b>{{$listing->reoffice}}<br><b style="color:#606060">Email: </b>&nbsp;<a  href="mailto:{{$listing->agent_email}}" rel="notrack" style="border:none;color:#178acc;outline:none!important;text-decoration:underline" target="_blank">{{$listing->agent_email}}</a>@if($listing->agent_phone)<br><b style="color:#606060">Phone: &nbsp;</b>{{$listing->agent_phone}}@endif</p>
                                       @endif        
                                             </td>
                                           </tr>
                           </tbody>
                            {{--  <tbody>
                                    <tr>
                                        <td class="m_-2651509807509513694content-td" style="color:#818181;font-family:Helvetica,Arial,sans-serif;font-size:16px;line-height:150%;padding:0 0 60px"><span class="im">
                                                  
                                            <p class="m_-2651509807509513694intercom-align-left" style="font-size:16px;margin:0 0 13px;padding-left:10%;padding-right:10%;text-align:left!important" align="left">Hi there,&nbsp;you have got a question</p>
                                    <h2 class="m_-2651509807509513694intercom-align-left" style="color:#303030;font-size:21px;font-weight:bold;line-height:1.25;margin:30px 0 5px;padding-left:10%;padding-right:10%;text-align:left!important" align="left">From:</h2>
                                    <p class="m_-2651509807509513694intercom-align-left" style="font-size:16px;margin:0 0 13px;padding-left:10%;padding-right:10%;text-align:left!important" align="left"><b style="color:#606060">Name:</b> {{$user->first}} {{$user->last}}<br><b style="color:#606060">Email: </b><a href="mailto:{{$user->email}}" style="border:none;color:#178acc;outline:none!important;text-decoration:underline" target="_blank">{{$user->email}}</a><br><b style="color:#606060">Phone:</b> {{$user->phone}}<br><b style="color:#606060">IP:	</b>{{$data['ip_address']}}<br><b style="color:#606060">Country:</b> {{$data['country']}}</p>
                                    </span><h2 class="m_-2651509807509513694intercom-align-left" style="color:#303030;font-size:21px;font-weight:bold;line-height:1.25;margin:30px 0 5px;padding-left:10%;padding-right:10%;text-align:left!important" align="left">Question:</h2>
                                    <p class="m_-2651509807509513694intercom-align-left" style="font-size:16px;margin:0 0 13px;padding-left:10%;padding-right:10%;text-align:left!important" align="left">{{$data['message']}}</p>
                                    <h2 class="m_-2651509807509513694intercom-align-left" style="color:#303030;font-size:21px;font-weight:bold;line-height:1.25;margin:30px 0 5px;padding-left:10%;padding-right:10%;text-align:left!important" align="left">Subject Property:</h2>
                                    </span><p class="m_-2651509807509513694intercom-align-left" style="font-size:16px;margin:0;padding-left:10%;padding-right:10%;text-align:left!important" align="left"><span class="im"><b style="color:#606060"><br>MLS#:</b> <a href="{{route('listing-detail-page', $listing->slug)}}?agent={{$agent->vow_username}}">{{$listing->listingid}}</a><br><b style="color:#606060">Address:	</b><a href="{{route('listing-detail-page', $listing->slug)}}?agent={{$agent->vow_username}}">{{$listing->streetaddress}}, {{$listing->city}}</a><br><b style="color:#606060">Days On Market: </b>{{$listing->active_days_on_market()}}<br><b style="color:#606060">Listing Agent Name:</b> {{$listing->agent_name}}<br><b style="color:#606060">Listing Agent Brokerage:</b> {{$listing->reoffice}}<br><b style="color:#606060">Listing Agent Email:</b> &nbsp;<a href="mailto:{{$listing->agent_email}}" style="border:none;color:#178acc;outline:none!important;text-decoration:underline" target="_blank">{{$listing->agent_email}}</a><br><b style="color:#606060">Listing Agent Phone:</b> &nbsp;{{$listing->agent_phone}}<br></span></p>
