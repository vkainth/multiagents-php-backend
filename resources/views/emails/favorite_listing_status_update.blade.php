          					...
          					<tbody>
								<tr>
            						<td class="m_-927440389858369921m_-9098775995103606752content-td" style="color:#818181;font-family:Helvetica,Arial,sans-serif;font-size:16px;line-height:150%;padding:0 0 20px">
										<h1 class="m_-927440389858369921m_-9098775995103606752intercom-align-center" style="color:#2392ec!important;font-size:36px;font-weight:300;line-height:1.2;margin:0 0 5px;padding-left:10%;padding-right:10%;text-align:center!important" align="center">{{$user->first}}, Your Favorite Listing Update</h1>
										{{--  @if($listing->status == "Sold")
										<h1 class="m_-927440389858369921m_-9098775995103606752intercom-align-center" style="color:#2392ec!important;font-size:36px;font-weight:300;line-height:1.2;margin:0 0 5px;padding-left:10%;padding-right:10%;text-align:center!important" align="center">Just Sold</h1>
										@else
										<h1 class="m_-927440389858369921m_-9098775995103606752intercom-align-center" style="color:#2392ec!important;font-size:36px;font-weight:300;line-height:1.2;margin:0 0 5px;padding-left:10%;padding-right:10%;text-align:center!important" align="center">New Property</h1>
										@endif  --}}
										{{--  @if($listing->status == "Sold")
															...
															<tbody>
																<tr>
																	<td class="image" width="50%" height="210">
																		<a href="https://www.bccondosandhomes.com/listing/{{$listing->slug}}?ref=favorite_listing_status_update" target="_blank" rel="notrack" >
																	...
																	<td class="content" widht="50%">
																		<div style="font-weight:bold;font-size:20px;text-transform:uppercase;line-height:20px;font-family:Open-Sans,Arial;">
																			<a href="https://www.bccondosandhomes.com/listing/{{$listing->slug}}?ref=favorite_listing_status_update" target="_blank" rel="notrack"  style="color:#ee4223;text-decoration:none;">
																				@if($listing->status == 'Sold') JUST SOLD @else {{$listing->status}} @endif
																			</a>
																		</div>
																		<div style="font-weight:normal;font-size:20px;line-height:30px;font-family:Open-sans,Arial;text-overflow:ellipsis;overflow:hidden;">
																				<a href="https://www.bccondosandhomes.com/listing/{{$listing->slug}}?ref=favorite_listing_status_update" rel="notrack"  target="_blank" style="color:#333;text-decoration:none">
																				...
																				<div style="line-height:22px;text-overflow:ellipsis;overflow:hidden;font-weight:bold;text-decoration:none;font-size:15px;font-family:Open-sans,Arial">
																						<a href="https://www.bccondosandhomes.com/listing/{{$listing->slug}}?ref=favorite_listing_status_update" rel="notrack"  target="_blank" style="color:#2392ec;text-decoration:none">
																							{{$listing->streetaddress}}
																						</a>			
                                                                                </div>
                                                                                <div style="line-height:22px;text-overflow:ellipsis;overflow:hidden;font-weight:bold;text-decoration:none;font-size:15px;font-family:Open-sans,Arial">      
                                                                                        <a href="https://www.bccondosandhomes.com/listing/{{$listing->slug}}?ref=favorite_listing_status_update" rel="notrack"  target="_blank" style="color:#2392ec;text-decoration:none;text-align:left">
                                                                                ...
                                                                                {{--  @if($listing->status == 'Sold')  --}}
                                                                                <div style="">
                                                                                        <a href="https://www.bccondosandhomes.com/listing/{{$listing->slug}}?ref=favorite_listing_status_update" rel="notrack"  target="_blank" style="text-decoration: none;color: #ed4222;font-size: 15px;">View Detail</a>
                                                                                </div>
                                                                                {{--  @endif  --}}
																	</td>
																</tr>
