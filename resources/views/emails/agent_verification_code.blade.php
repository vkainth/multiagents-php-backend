                     ...
                     <table width="100%" class="m_-57277933998419376content" style="border-collapse:separate;border-spacing:0;table-layout:fixed">
                            <tbody>
                                <tr>
                                    ...
                                    <p class="m_-1572755854613106647intercom-align-left" style="font-size:16px;margin:0 0 13px;padding-left:10%;padding-right:10%;text-align:left!important" align="left">Hi {{$user->first}} {{$user->last}}, &nbsp;</p>
                                    <p class="m_-1572755854613106647intercom-align-left" style="font-size:16px;margin:0;padding-left:10%;padding-right:10%;text-align:left!important" align="left">Your Fisherly verification code is <strong>{{$code}}</strong>.<br/></p>
