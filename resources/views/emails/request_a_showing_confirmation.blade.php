                     ...
                     <table width="100%" class="m_-57277933998419376content" style="border-collapse:separate;border-spacing:0;table-layout:fixed">
                            <tbody>
                                <tr>
                                    ...
                                    <p class="m_-1572755854613106647intercom-align-left" style="font-size:16px;margin:0 0 13px;padding-left:10%;padding-right:10%;text-align:left!important" align="left">Hi {{$data['user_name']}}, &nbsp;</p>
                                    <p class="m_-1572755854613106647intercom-align-left" style="font-size:16px;margin:0;padding-left:10%;padding-right:10%;text-align:left!important" align="left">We have received your request for showing at <strong>{{$data['listing_address']}}</strong>. &nbsp;Expect a response from <strong>{{$data['agent_name']}}</strong> shortly. <br><br>Thank you for using Fisherly.&nbsp;</p>
