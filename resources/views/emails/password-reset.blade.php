...
<div class="wrap">
  ...
  <div class="body">
    <p>Hi,</p>
    <p>We received a request to reset the password for your account ({{ $email }}). Click the button below to set a new password.</p>
    <a class="btn" href="{{ $resetUrl }}">Reset Password</a>
    <p style="color:#888;font-size:14px">This link expires in 1 hour. If you didn't request a password reset, you can safely ignore this email — your password won't change.</p>
    <p class="url-fallback">Or copy this link: {{ $resetUrl }}</p>
  </div>
  <div class="footer">© {{ date('Y') }} {{ $agentName ?? '' }}. You received this because a password reset was requested for this email address.</div>
</div>
</body>
</html>
