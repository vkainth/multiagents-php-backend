      				...
      				<td style="font-family:Helvetica,Arial,sans-serif;font-size:16px;padding:60px 0 0">
          					...
          					<tbody>
								<tr>
            						<td class="m_-927440389858369921m_-9098775995103606752content-td" style="color:#818181;font-family:Helvetica,Arial,sans-serif;font-size:16px;line-height:150%;padding:0 0 20px">
                                        <h1 class="m_-927440389858369921m_-9098775995103606752intercom-align-center" style="color:#2392ec!important;font-size:36px;font-weight:300;line-height:1.2;margin:0 0 5px;padding-left:10%;padding-right:10%;text-align:center!important" align="center">{{-- {-{$user->first}}, --}} Your Favorite Listing Tracking Update</h1>
                                    </td>
          						</tr>
        					</tbody>
						</table>
						...
						<table width="100%" class="m_-927440389858369921m_-9098775995103606752content" style="border-collapse:separate;border-spacing:0;table-layout:fixed">
          					<tbody>
								<tr>
            						<td class="m_-927440389858369921m_-9098775995103606752content-td" style="color:#818181;font-family:Helvetica,Arial,sans-serif;font-size:16px;line-height:150%;padding:0 0 20px">
                                        <div class="" style="color:#2392ec!important;font-size:16px;font-weight:300;line-height:1.2;margin:0 0 5px;padding-left:10%;padding-right:10%;text-align:center!important" align="center">
                                        	Listing Price increased from $544,000 to $560,000 
                                        </div>
                                    </td>
          						</tr>
        					</tbody>
															...
															<tbody>
																<tr>
																	<td class="image" width="50%" height="210">
																			<a href="https://www.bccondosandhomes.com/listing/{-{$listing->slug}}?ref=favorite_listing_price_update" rel="notrack"  target="_blank">
																	...
																	<td class="content" width="50%">
																				<div style="font-weight:bold;font-size:20px;text-transform:uppercase;line-height:20px;font-family:Open-Sans,Arial">
																						<a href="https://www.bccondosandhomes.com/listing/{-{$listing->slug}}?ref=favorite_listing_price_update" target="_blank"  rel="notrack" style="color:#0077B5;text-decoration:none;">
																							Price Drop
																						</a>
																					</div>
																				<div style="font-weight:normal;font-size:20px;line-height:30px;font-family:Open-sans,Arial;text-overflow:ellipsis;overflow:hidden;">
																						<a href="https://www.bccondosandhomes.com/listing/{-{$listing->slug}}?ref=favorite_listing_price_update"  rel="notrack"  target="_blank" style="color:#333;text-decoration:none">
																							{-{money_format('%.0n', $listing->listprice_2)}}
                                                                                            <br/>
                                                                                            <span style="text-decoration: line-through;">{-{money_format('%.0n', ($listing->listprice_2+$price_decreased))}}</span>
																						</a>
																					</div>
																				...
																				<div style="line-height:22px;overflow:hidden;font-weight:bold;text-decoration:none;font-size:15px;font-family:Open-sans,Arial;text-overflow:ellipsis" >
																						<a href="https://www.bccondosandhomes.com/listing/{-{$listing->slug}}?ref=favorite_listing_price_update" rel="notrack"  target="_blank" style="color:#2392ec;text-decoration:none">
																							{-{$listing->streetaddress}}
																						</a>	
                                                                                </div>
                                                                                <div style="line-height:22px;overflow:hidden;font-weight:bold;text-decoration:none;font-size:15px;font-family:Open-sans,Arial;text-overflow:ellipsis">
                                                                                        <a href="https://www.bccondosandhomes.com/listing/{-{$listing->slug}}?ref=favorite_listing_price_update" rel="notrack"  target="_blank" style="color:#2392ec;text-decoration:none;text-align:left">
                                                                                ...
                                                                                <div style="">
                                                                                        <a href="https://www.bccondosandhomes.com/listing/{-{$listing->slug}}?ref=favorite_listing_price_update" rel="notrack"  target="_blank" style="text-decoration: none;color: #0077B5;font-size: 15px;">View Detail</a>
                                                                                </div>	
																	</td>
																</tr>
															</tbody>
