               ...
               <tr>
                  ...
                  <!-- END LOGO -->
                     <table width="100%" class="m_-57277933998419376content" style="border-collapse:separate;border-spacing:0;table-layout:fixed">
                            <tbody>
                                <tr>
                                    <td class="m_-1572755854613106647content-td" style="color:#818181;font-family:Helvetica,Arial,sans-serif;font-size:16px;line-height:150%;padding:0 0 60px">
                                                  
                                    <p class="m_-1572755854613106647intercom-align-left" style="font-size:16px;margin:0 0 13px;padding-left:10%;padding-right:10%;text-align:left!important" align="left">Hi there, &nbsp;</p>
                                    <p class="m_-1572755854613106647intercom-align-left" style="font-size:16px;margin:0;padding-left:10%;padding-right:10%;text-align:left!important" align="left">{{$user->first}} {{$user->last}} has been requested agent verification code {{$user->code_request_times}} times.</p>
                                    <p class="m_-1572755854613106647intercom-align-left" style="font-size:16px;margin:0;padding-left:10%;padding-right:10%;text-align:left!important" align="left">Agent Fisherly user id is {{$user->id}}</p>
                                    <p class="m_-1572755854613106647intercom-align-left" style="font-size:16px;margin:0;padding-left:10%;padding-right:10%;text-align:left!important" align="left"><br/>Team Fisherly</p>
