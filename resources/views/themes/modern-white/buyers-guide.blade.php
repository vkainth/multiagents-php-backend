    ...
    <div style="display:grid;grid-template-columns:260px 1fr;gap:56px;align-items:start;">
      ...
      <div>
        ...
        <div class="cta-block" style="margin-top:40px;">
          <p class="eyebrow mb-12">Ready to Start?</p>
          <h3 class="h3 cta-block__title" style="margin-bottom:10px;">Start Your Search</h3>
          <p class="cta-block__sub">{{ explode(' ', $agent->name)[0] }} has helped hundreds of buyers in {{ $territories->keys()->first() }} — from first-timers to investors.</p>
          <div style="display:flex;gap:14px;justify-content:center;flex-wrap:wrap;">
            <a href="{{ route('agent.search', $agent->slug) }}" class="btn-cta">Browse Listings</a>
            <a href="{{ route('agent.home-evaluation', $agent->slug) }}" class="btn-outline">Get Pre-Qual Help</a>
          </div>
        </div>
      </div>
    </div>
