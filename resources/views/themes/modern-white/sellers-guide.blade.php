      ...
      <div>
        <div id="step-eval" class="guide-section">
          ...
          <div class="guide-tip">
            ...
            <a href="{{ route('agent.home-evaluation', $agent->slug) }}" style="color:var(--text);text-decoration:underline;">Request yours →</a>
          </div>
        </div>
        ...
        <div id="step-pricing" class="guide-section">
          ...
          <p>{{ explode(' ', $agent->name)[0] }}'s experience in {{ $territories->keys()->first() }} means he knows which buildings command premiums, which streets buyers prefer, and how seasonal timing affects values.</p>
          <div class="guide-tip">
        ...
        <div class="cta-block" style="margin-top:40px;">
          ...
          <h3 class="h3 cta-block__title" style="margin-bottom:10px;">Find Out What Your Home Is Worth</h3>
          <p class="cta-block__sub">Free, no-obligation evaluation within 6 hours. Based on real sold comparables.</p>
