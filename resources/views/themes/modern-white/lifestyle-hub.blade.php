...
<div class="container">
  ...
  @else
  <section class="section">
    <p style="color:var(--muted);font-size:15px;">No {{ strtolower($lifestyleLabel) }} listings found. <a href="{{ route('agent.search', $agent->slug) }}" style="color:var(--text);text-decoration:underline;">View all listings</a>.</p>
  </section>
  @endif
</div>
@endsection
