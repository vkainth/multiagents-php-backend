...
<html lang="en">
<head>
<title> {{!empty($title)?$title:':'}} | Hani & Les | BC Condos And Homes </title>
<meta charset="utf-8">
...
<div class="text-black text-5xl md:text-5xl font-black"> {{!empty($code)?$code:'--'}} </div>
<div class="w-16 h-1 bg-purple-light my-3 md:my-6"></div>
<p class="text-grey-darker text-2xl md:text-3xl font-light mb-8 leading-normal"> {{!empty($message)?$message:'Unavailable!'}} </p>
<a href="https://www.bccondosandhomes.com">
...
<div style="background-image: url(https://www.bccondosandhomes.com/svg/403.svg);" class="absolute pin bg-cover bg-no-repeat md:bg-left lg:bg-center">
</div>
</div>
</div>
<script defer src="https://static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"rayId":"6a5782b7196761f3","token":"9edb1e18508441d9ba2482277eae7183","version":"2021.10.0","si":100}'></script>
</body>
</html>
