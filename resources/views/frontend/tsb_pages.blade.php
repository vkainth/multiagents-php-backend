...
@section('meta_description')Les Twarog was licenced in 1988 and has sold thousands of houses. Selling your home with Les and his team is a no-brainer. Service area includes Vancouver, Burnaby, Coquitlam, Port Coquitlam, Surrey, Langley, Cloverdale, Richmond,Delta, Tsawwassen, Mission, Maple Ridge, Squamish, Bowen Island, West Vancouver, North Vancouver, Richmond, Delta, Abbotsford, Chilliwack, Vancouver West, Vancouver East, Ladner, Gibsons, Sunshine Coast, Whistler, Aldergrove, Pemberton, Port Moody, New Westminster, Pitt Meadows, White Rock  @endsection
 --}}
@if( ($tsbPage??false) == 'sell')
@section('title')Selling Home In Greater Vancouver & Fraser Valley - Hani & Les | BC Condos And Homes @endsection
@endif
@section('meta')
...
<div class="main spcs__main spcs__main" role="main">
    ...
    <div class="">
        <div class="spcs__banner bg-sellers-experience-hero">
            ...
            <div class="container pad-y100 text-right">
                ...
                <h1 class="row"><span class="h-thin h-thin-big col-md-8 pull-right" style="font-size: 5rem;">Most Visited and Recommended Real Estate Team by Sellers and Buyers
                <br/><span style="font-size:32px;">- Hani & Les | BC Condos And Homes</span>
                </span>
                <br>
            ...
            <div class="row flexbox__first--center">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="">
                        ...
                        <p class="text-justify"> Hani & Les | BC Condos And Homes has more than 450 Google Reviews averaging 4.8 out of 5. Why would you trust anyone else to sell your home? </p>
                        {{-- <i>(With over 425+ Google Reviews (4.7/5), why trust anyone else?)</i> --}}
                        <br><br>
                        <a href="{{-- #linkPending --}}" onclick="window.location.href='{{route('external-whatsmyhomeworth')}}';return false;" class="btn-info margin-b2 btn bcch-btn bcch-bg-cyan">What is my property worth?</a>
                        <br>
                    </div>
                </div>
            ...
            <div class="row flexbox__first--center">
                <div class="col-md-6 col-sm-6 col-xs-12 ">
                    <div class="">
                        ...
                        <br><br>
                        <a href="{{-- #linkPending --}}" onclick="window.location.href='{{route('external-whatsmyhomeworth')}}';return false;" class="btn-warning margin-b2 btn bcch-btn bcch-bg-golden">Complete Client Application</a>
                        <br>
                    </div>
                </div>
            ...
            <div class="row flexbox__first--center">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 left-border-wht ">
                    <div class="">
                        ...
                        <br><br>
                        <a href="{{route('external-whatsmyhomeworth')}}" class="btn-info margin-b2 btn bcch-btn bcch-bg-cyan">Find Out the Value of Your Home</a>
                        <br>
                    </div>
                </div>
    ...
    <div class="">
        <div class="spcs__banner bg-buyers-experience-hero">
            <div class="container pad-y100">
                ...
                <h1 class="row"><span class="h-thin h-thin-big col-md-8">Top 50 Team In Western Canada Remax (2022,2023,2024)</span></h1>
                <div class="row">
                    <div class="col-md-8">
                        <p>Search for properties, book showings, review building information and much more with the Hani & Les | BC Condos And Homes.</p>
                    </div>
                </div>
                <br>
                <p class=""><a href="{{route('landing')}}" {{-- onclick="window.Intercom('showNewMessage','I want to '+jQuery(this).text().replaceAll('Your', 'My'));return false;" --}} class="btn-info margin-b2 btn bcch-bg-cyan">Search with Hani & Les | BC Condos And Homes</a></p>
            </div>
        </div>
    </div>
            ...
            <div class="row flexbox__first--center">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="">
                        ...
                        <br><br>
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSfjrPZZdRnUlJcmSQ6qpR6WkkfExSWTeFNpCsNqzS2GPzSoFg/viewform" {{-- onclick="window.Intercom('showNewMessage','I want to '+jQuery(this).text().replaceAll('Your', 'My'));return false;" --}} class="btn-warning margin-b2 btn bcch-btn bcch-bg-golden">Sign Up as a Client</a>
                        <br>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 left-border-sld" >
                    ...
                    <div class="item__list">
                        <h3>A Local Hani & Les | BC Condos And Homes Agent as Your Guide</h3>
    ...
    <div class="container flexbox__first--center flx-cover" style="padding-right: 0;">
        <div class="col-md-6 col-sm-6 pad-y100">
            ...
            <br>
            <p class=""><a href="https://docs.google.com/forms/d/e/1FAIpQLSfjrPZZdRnUlJcmSQ6qpR6WkkfExSWTeFNpCsNqzS2GPzSoFg/viewform" {{-- onclick="window.Intercom('showNewMessage','I want to '+jQuery(this).text().replaceAll('Your', 'My'));return false;" --}} class="btn-info margin-b2 btn bcch-btn bcch-bg-cyan">Complete Buyer Application</a></p>
        </div>
    ...
    <div class="container flexbox__first flexbox__first--center " style="padding-right: 0;">
        <div class="col-md-6 col-sm-6">
            ...
            <br>
            <p class=""><a href="{{-- #linkPending --}}" class="btn-info margin-b2 btn bcch-btn bcch-bg-cyan">Buy with Hani &amp; Les | BC Condos And Homes</a></p>
        </div>
                        ...
                        <i>(Because, why wouldn't you sell with the best team!?)</i>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 left-border-wht" >
                                        ...
                                        <div class="item__list">
                                                ...
                                                <p>Get your listing featured on our Hani & Les | BC Condos And Homes website with exposure to more than 100,000 registered users and 150,000+ visitors per month.</p>
                                        </div>
                                </div>
                        </div>
                </div>
        ...
        <div id="our-team" class="white__bg text__section--3 wrap_team_agents">
                <div class="container">
                    <div class="row" style="margin-bottom:30px;">
                        ...
                        @php
                        $_teamAgentsRaw = Helper::getTeamAgentsNew();
                        $_teamAgents222 = [];
                        foreach ($_teamAgentsRaw as $_rawAgent) {
                            $_formatted = Helper::format_team_agent_for_display($_rawAgent);
                            $_formatted['languages'] = trim($_rawAgent->languages ?? '');
                            $_formatted['video'] = trim($_rawAgent->video ?? '');
                            $_teamAgents222[] = $_formatted;
                        }
                        @endphp
