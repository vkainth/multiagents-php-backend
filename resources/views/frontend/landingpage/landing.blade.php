...
<section class="v2-hero">
    <div class="v2-hero__inner">
        ...
        <div class="v2-hero__agents">
            ...
            <div class="v2-hero__agent-wrap">
                <img class="v2-hero__agent-photo" src="{{ asset('frontend/images/teamagents/les_twarog.jpg') }}" alt="Les Twarog REALTOR Since 1988">
                <div class="v2-hero__agent-name">
                    Les Twarog
...
{{-- ══ TOP BUILDINGS ═══════════════════════════════════════════════ --}}
<section class="v2-section" style="padding-left:24px;padding-right:24px;">
    ...
    @php $topBuildings = Helper::getStaticTopBuilding(); @endphp
    @if(count($topBuildings))
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:16px;">
        @foreach($topBuildings as $building)
        <a href="{{route('building-detail-page',['slug'=>$building->slug])}}"
           style="display:block;border-radius:10px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,.1);transition:transform .2s,box-shadow .2s;color:inherit;text-decoration:none;"
           ...
           onmouseout="this.style.transform='';this.style.boxShadow='0 2px 12px rgba(0,0,0,.1)'">
            <div style="position:relative;height:200px;overflow:hidden;background:#e8eaf0;">
                <img src="{{$building->main_image()}}" alt="{{$building->name}}" loading="lazy"
                     style="width:100%;height:100%;object-fit:cover;filter:brightness(0.82);">
                {{-- City pill — top-left gold accent --}}
                @if(!empty($building->city_label))
                <div style="position:absolute;top:10px;left:10px;background:#b8972a;color:#fff;font-size:11px;font-weight:700;letter-spacing:.5px;padding:3px 10px;border-radius:20px;text-transform:uppercase;line-height:1.6;">
                    {{$building->city_label}}
                </div>
                @endif
                {{-- Building name + address gradient overlay — bottom --}}
                <div style="position:absolute;bottom:0;left:0;right:0;background:linear-gradient(transparent,rgba(10,25,55,0.88));padding:24px 12px 12px;">
                    <div style="color:#fff;font-size:13px;font-weight:700;line-height:1.3;">{{$building->name}}</div>
                    <div style="color:rgba(255,255,255,.72);font-size:11px;margin-top:3px;">{{$building->geo_address}}</div>
                </div>
            </div>
        </a>
        @endforeach
...
<div style="background:#f7f4ef;padding:32px 24px;">
    <div class="container">
        <div style="text-align:center;margin-bottom:20px;">
            <div style="font-size:11px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:#2c6fad;margin-bottom:6px;">Market Intelligence</div>
            <h2 style="font-size:20px;font-weight:700;color:#2c2c2c;margin:0 0 4px;">Stay Ahead of the BC Market</h2>
            <p style="font-size:13px;color:#888;margin:0;">Live feeds updated daily — no login required</p>
        </div>
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;max-width:860px;margin:0 auto;">
            <a href="/new-listings/vancouver" style="display:flex;align-items:center;gap:14px;background:#fff;border-radius:8px;padding:16px 18px;text-decoration:none;color:#333;box-shadow:0 2px 8px rgba(0,0,0,.07);">
                <span style="font-size:26px;flex-shrink:0;">🆕</span>
                <div><div style="font-size:14px;font-weight:700;color:#2c6fad;">New This Week</div><div style="font-size:12px;color:#888;margin-top:2px;">Listings added in the last 7 days</div></div>
            </a>
            <a href="/price-reductions/vancouver" style="display:flex;align-items:center;gap:14px;background:#fff;border-radius:8px;padding:16px 18px;text-decoration:none;color:#333;box-shadow:0 2px 8px rgba(0,0,0,.07);">
                <span style="font-size:26px;flex-shrink:0;">📉</span>
                <div><div style="font-size:14px;font-weight:700;color:#e74c3c;">Price Reductions</div><div style="font-size:12px;color:#888;margin-top:2px;">Recent price drops in the last 14 days</div></div>
            </a>
            <a href="/sold-over-asking/vancouver" style="display:flex;align-items:center;gap:14px;background:#fff;border-radius:8px;padding:16px 18px;text-decoration:none;color:#333;box-shadow:0 2px 8px rgba(0,0,0,.07);">
                <span style="font-size:26px;flex-shrink:0;">🏆</span>
                <div><div style="font-size:14px;font-weight:700;color:#27ae60;">Sold Over Asking</div><div style="font-size:12px;color:#888;margin-top:2px;">Properties that sold above list price</div></div>
            </a>
            <a href="/market-update/vancouver" style="display:flex;align-items:center;gap:14px;background:#fff;border-radius:8px;padding:16px 18px;text-decoration:none;color:#333;box-shadow:0 2px 8px rgba(0,0,0,.07);">
                <span style="font-size:26px;flex-shrink:0;">📊</span>
                <div><div style="font-size:14px;font-weight:700;color:#2c6fad;">Monthly Updates</div><div style="font-size:12px;color:#888;margin-top:2px;">City-level stats, trends & conditions</div></div>
            </a>
        </div>
    </div>
</div>
