...
<form action="" method="post" style="font-family:verdana; margin:auto;padding:20vh 20vw;text-align:center;">
    @csrf
...
{{Debugbar::info(['Subscriptn: '=> App\Models\Subscription::where('firebase_user_id',auth()?->user()->id)?->first()?->toArray()],true)}}
